    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/li-pengeluaran/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/li-pengeluaran/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/li-pengeluaran/create'
                  }
                },
                window.location.href = '#/admin/li-pengeluaran/create')
        ...
        back() {
            window.location = '#/admin/li-pengeluaran';
        }
    },
    mounted: function() {
        axios.get("/li-pengeluaran/create").then(response => {
